...
import PipelineLane from "@/app/(main)/subaccount/[subaccountId]/pipelines/_components/pipeline-lane";
...
const PipelineView: React.FC<Props> = ({
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div
        className={
          "bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in"
        }
      >
