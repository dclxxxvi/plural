...
// TODO: Create the plan access restrictions
const Page: React.FC<Props> = async ({ params }) => {
  ...
  return (
    <>
      ...
      <div
        className={"flex flex-col lg:!flex-row flex-wrap justify-between gap-8"}
      >
        <PricingCard
          planExists={isActiveSubscription}
          prices={prices.data}
          customerId={agencySubscription?.customerId || ""}
          amt={isActiveSubscription ? currentPlanDetails?.price || "$0" : "$0"}
          buttonCta={isActiveSubscription ? "Change Plan" : "Get Started"}
